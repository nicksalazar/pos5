    ...
    class PurchaseController extends Controller
    {
        ...
        public function tables()
        {
            ...
            return compact('suppliers', 'establishment', 'currency_types', 'discount_types', 'configuration', 'payment_conditions',
                'charge_types', 'document_types_invoice','retention_types_income','retention_types_iva','company', 'payment_method_types', 'payment_destinations', 'customers', 'warehouses','permissions', 'global_discount_types');
        }
