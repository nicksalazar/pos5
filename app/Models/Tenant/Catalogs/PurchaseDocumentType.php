<?php
     ...
     * @method static Builder|PurchaseDocumentType documentsActiveToPurchase()
     * @method static Builder|PurchaseDocumentType newModelQuery()
     * @method static Builder|PurchaseDocumentType newQuery()
     * @method static Builder|PurchaseDocumentType onlyActive()
     * @method static Builder|PurchaseDocumentType onlyAvaibleDocuments()
     * @method static Builder|ModelCatalog orderByDescription()
     * @method static Builder|PurchaseDocumentType query()
     * @method static Builder|ModelCatalog whereActive()
     */

    class PurchaseDocumentType extends ModelCatalog
    {
        use UsesTenantConnection;

        public const SALE_DOCUMENT_TYPES = ['01', '02'];

        public $incrementing = false;
        protected $table = "cat_purchase_document_types";
        protected $fillable = [
            'active',
            'short',
            'description'
        ...
        {
            return $query->OnlyActive()->wherein('id', ['01', '02', '03', '04', '05', '06', '07']);
        }
        ...
        {
            return $query->OnlyActive()->wherein('id', ['01', '02', '03', '04', '05', '06', '07', '08', '09', '11', '12', '15']);
        }

        public function scopeDocumentsActiveToSettlement($query)
        {
            return $query->OnlyActive()->wherein('id', ['03']);
        }
        ...
        public function getCurrentRelatiomClass(){
            //06	1		GUIA DE REMISIÓN REMITENTE
            ...
            //02	1	BV	BOLETA DE VENTA ELECTRÓNICA
            //elseif($this->id == '02'){ return Document::class;}
            //04	1	NC	NOTA DE CRÉDITO
            elseif($this->id == '04'){ return Document::class;}
            //05	1	ND	NOTA DE DÉBITO
            elseif($this->id == '05'){ return Document::class;}
            // elseif($this->id == '06'){ return Document::class;}
            ...
            //02	1		NOTA DE VENTA
            elseif($this->id == '02'){ return SaleNote::class;}
            // elseif($this->id == '02'){ return Document::class;}
