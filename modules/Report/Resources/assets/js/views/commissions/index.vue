<template>
  <div class="card mb-0 pt-2 pt-md-0">
    ...
    <div class="card mb-0">
      <div class="card-body">
        <!-- <DxChart :applyCustomer="true" :resource="resource" ref="chart">
        ...
        <DxPivotGrid id="pivotgrid" ref="grid" :data-source="dataSource" :allow-sorting-by-summary="true"
          ...
          <div id="app-container">
            <DxPopup v-model:visible="isPopupVisible" :hide-on-outside-click="true" content-template="popup-content"
              :show-title="true" title="Filtros" :height="500" :width="500" :resize-enabled="true" :drag-enabled="true"
              position="center">
...
export default {
  ...
  mounted() {
    ...
    setTimeout(() => {
      dataSource.expandHeaderItem('row', ['1']);
      dataSource.expandHeaderItem('column', ['Administrador']);
    }, 3000);*/
  },
