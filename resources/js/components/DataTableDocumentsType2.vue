...
export default {
        ...
        data () {
            return {
                ...
                estados: [{'id':1,'description':'Activo'},{'id':2,'description':'Inactivo'}],
        ...
        methods: {
            ...
            getRecords() {
                ...
                return this.$http.get(`/${this.resource}/document_types/records?${this.getQueryParameters()}`).then((response) => {
                    console.log(response.data)
