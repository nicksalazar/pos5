    ...
    <div>
        <div class="page-header pr-0">
            ...
            <ol class="breadcrumbs">
                ...
                <li><span class="text-muted">Tipos de Documentos</span>
                </li>
            </ol>
            ...
            <div class="card-body ">
                <data-table :resource="resource">
                    ...
                    <tr slot="heading">
                        ...
                        <th>#</th>
                        <th class="text-center" style="min-width: 95px;">ID</th>
                        <th class="text-center" style="min-width: 95px;">Activo</th>
                        <th class="text-center" style="min-width: 95px;">Descripción</th>
                        <th class="text-center" style="min-width: 95px;">Documento Relacionado</th>
                        <th class="text-center" style="min-width: 95px;">Contable</th>
                        <th class="text-center" style="min-width: 95px;">Altera stock</th>
                        <th class="text-center" style="min-width: 95px;">Signo</th>
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" >
                                    <div >
                                        <button class="dropdown-item"
                                                @click.prevent="clickCreate(row.idType)">Editar
                                        </button>
                                    </div>
...
import DataTable from '../../../components/DataTableDocumentsType2.vue'
